        ...
        userInfo && (
            <div className="container-col w-[90%] py-4 mx-auto gap-6">
                <div className="flex justify-between items-center">
                    <img src="/images/logo-title.png" alt="logo" className="h-[50px]" onClick={onClickLogo} />
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="flex flex-col">
                        <div className="flex items-center space-x-3">
                            ...
                            <img src="/icons/edit.svg" alt="edit" className="w-[20px] h-[20px]" onClick={onEditProfile} />
                        </div>
                ...
                <div className="flex flex-col space-y-4 px-2">
                    <div className='flex items-center justify-between'>
                        ...
                        <img src="/icons/chevron-right.svg" alt="arrow" className="w-[24px] h-[24px]" onClick={onClickMoreFriends} />
                    </div>
                    <div className="flex items-center space-x-4">
                        {FRIENDS.map(friend => ( // 상위 3명
